...
public class Pnl_LHD extends JPanel implements ActionListener, MouseListener, KeyListener{
	...
	public Pnl_LHD() {
		...
		JLabel lbl = new JLabel("LẬP HÓA ĐƠN");
		...
		btn_them = new JButton("Thêm SP vào HD");
		...
		JLabel lbl_pdh = new JLabel("HÓA ĐƠN");
